...
final class Elementor_Doccure {
	...
	public function load_localisation() {
		...
		load_plugin_textdomain( 'doccure_elementor', false,  basename( dirname( __FILE__ ) ) . '/languages/' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_DOCCURE ) );
