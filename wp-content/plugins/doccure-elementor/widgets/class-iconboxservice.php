 ...
 * @since 1.0.0
 */
class IconBoxService extends Widget_Base {
	...
	public function get_title() {
		return __( 'Icon Box Service', 'doccure_elementor' );
	}
			...
			if(!empty($settings['url']['url'])){
				...
				<?php if($settings['content']!='') { ?>
					<div class="wpb_text_column ">
						<div class="wpb_content_element "><p><?php echo $this->get_settings( 'content' ) ?></p></div>
					</div>
						<?php } ?>
