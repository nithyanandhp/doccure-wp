 ...
 * @since 1.0.0
 */
class Widget_Doccure_Accordion extends Widget_Base {
	...
	public function get_title() {
		return __( 'Doccure Accordion', 'doccure_elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_toggle',
			[
				'label' => esc_html__( 'Accordion', 'doccure_elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Accordion Items', 'doccure_elementor' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Accordion #1', 'doccure_elementor' ),
					...
					[
						'tab_title' => esc_html__( 'Accordion #2', 'doccure_elementor' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'doccure_elementor' ),
					],
				],
...
<div class="card">
    ...
    <div class="card-header collapsed" type="button" id="headingOne_<?php echo $tab_count; ?>" data-bs-toggle="collapse" data-bs-target="#collapseOne_<?php echo $tab_count; ?>" <?php if($tab_count=='1') { ?>aria-expanded="true" <?php } else { ?> aria-expanded="false" <?php } ?>  aria-controls="collapseOne_<?php echo $tab_count; ?>">
