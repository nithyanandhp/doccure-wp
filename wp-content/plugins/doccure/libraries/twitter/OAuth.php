 ...
 * verified way to the doccure, in a manner which is beyond the scope of this 
 * specification.
...
class OAuthServer {
  ...
  private function get_version(&$request) {
    ...
    if (!$version) {
      // doccure MUST assume the protocol version to be 1.0 if this parameter is not present. 
