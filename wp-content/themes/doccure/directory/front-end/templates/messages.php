...
$hide_chat_buble	= !empty( $doccure_options['hide_chat_buble']) ? $doccure_options['hide_chat_buble']: 'no';
$post_id 		= $post->ID; 
...
if( !empty( $hide_chat_buble ) && $hide_chat_buble === 'no' && ( !empty( $doccure_options['chat'] ) && ( $doccure_options['chat'] === 'chat' || $doccure_options['chat'] === 'inbox' ) ) ){
?>
