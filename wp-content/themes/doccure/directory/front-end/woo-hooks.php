				...
				if( !empty( $order_detail ) ) {?>
					<div class="row">
						<div class="col-md-12">
							...
							<div class="cart-data-wrap_newstyle">
										...
										if( !empty($payment_type) && $payment_type === 'bookings') {?>
											<?php if( $key === 'service' ) { ?>
												...
												<?php 
													...
													?>
														<div class="cart-style"> 
															<label><span class="style-lable"><?php echo doccure_get_term_name( $v ,'services');?></span></label> 
															<span class="style-name"><?php echo doccure_get_booking_services_value( $key,$v,$order_detail );?></span> 
														</div>
													<?php } ?>
												<?php } ?>
											<?php } else { ?>
												<div class="cart-style">
													<label><span class="style-lable"><?php echo doccure_get_booking_payment_title( $key );?></span></label> 
													<span class="style-name"><?php echo doccure_get_booking_value( $value,$key,$order_detail );?></span> 
												</div>
											<?php }?>
